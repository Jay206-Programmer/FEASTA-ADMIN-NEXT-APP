...
export default function menu() {
    ...
    async function delItem(e) {
        ...
        var del_id = localStorage.getItem("del_id")?JSON.parse(localStorage.getItem("del_id")).del_id:"-1"
        var adm_id = localStorage.getItem("admin_id")?JSON.parse(localStorage.getItem("admin_id")).admin_id:"-1"
                ...
                <div className="card shadow mb-4">
                    ...
                    <div className="d-inline-flex flex-row w-100 justify-content-between align-items-center h-100 mb-2">
                        ...
                        <div className="dropdown-menu animate slideIn bg-gradient-light" aria-labelledby="dropdownMenuButton">
                            ...
                            <div className="dropdown-divider" />
                            <Link href="/dashboard/add/category"><a className="dropdown-item">Add/Edit Catagories</a></Link>
                        </div>
                        </div>
                    ...
                    <div className="table-responsive">
                        ...
                        {table.map((data)=>{
                            ...
                            return(<tr>
                                ...
                                <Link href='/dashboard/edit/item'><a style={{color: 'green',cursor:"pointer",margin:"15px"}} onClick={(e)=>{localStorage.setItem("item_id",JSON.stringify({item_id:data.item_id}))}}><i className="fas fa-fw fa-pen"/></a></Link>
                                ...
                                <a style={{color: 'red',cursor:"pointer"}} onClick={(e)=>{localStorage.setItem("del_id",JSON.stringify({del_id:data.item_id}));delItem(e)}}><i className="fas fa-fw fa-trash-alt" /></a>
                                </td>
                            </tr>)
                        })}
                        </tbody>
