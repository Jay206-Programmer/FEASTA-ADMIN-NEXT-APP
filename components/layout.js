...
export default function Layout({ children }) {
  ...
  //? Components
  const Logo = () => (
    <img src={require("../public/img/feasta.jpeg")} width={47} height={47} />
  );
                ...
                >
                  <div className="bg-white py-2 collapse-inner rounded">
                    ...
                    <Link href="/dashboard/menu">
                      <a className="collapse-item">Menu Updation</a>
                    </Link>
                    <Link href="/dashboard/add/category">
                      <a className="collapse-item">Add Category</a>
                    </Link>
                    <Link href="/dashboard/add/item">
                      <a className="collapse-item">Add Item</a>
                    </Link>
                  </div>
                </div>
              </li>
